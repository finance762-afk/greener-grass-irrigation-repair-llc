 ...
 */
$ppSlug = isset($partnerProfileSlug) && $partnerProfileSlug !== '' ? (string) $partnerProfileSlug : 'greener-grass-irrigation-repair-llc-mesa-az';
$ppName = isset($partnerProfileName) && $partnerProfileName !== '' ? (string) $partnerProfileName : 'Greener Grass Irrigation Repair LLC';
